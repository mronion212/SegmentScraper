...
reviewChecks.append($('validate-upload').parentElement,$('upload-progress'),$('introdb-comparison-panel'),$('upload-payload').closest('details'),$('override-fields'),$('submit-upload'));
