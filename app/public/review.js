...
reviewChecks.append($('validate-upload').parentElement,$('upload-progress'),$('introdb-comparison-panel'),$('upload-payload').closest('details'),$('review-confirm').parentElement,$('introdb-review-confirm').parentElement,$('override-fields'),$('submit-upload'));
